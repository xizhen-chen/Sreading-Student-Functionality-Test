...
- 网络信号：GET https://sr.sigmareading.com/images/mascot-two.png；GET https://sr.sigmareading.com/services/sr-ms-core/api/readings?page=0&size=3&count=0&recs=true；GET https://sr.sigmareading.com/services/sr-ms-core/api/readings?page=2&size=3&count=0&recs=true；GET https://sr.sigmareading.com/services/sr-ms-core/api/textbooks/sku-grouped；GET https://sr.sigmareading.com/services/tlc-ms-core/api/my-account/tl-orders?realm.equals=sr&sort=orderDate,desc&status.in=PAYING&page=0&size=5；GET https://sr.sigmareading.com/zh-hans/textbook
