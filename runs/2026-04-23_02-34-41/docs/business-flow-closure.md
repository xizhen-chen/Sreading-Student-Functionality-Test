...
> 配套矩阵：`business-flow-candidate-matrix.md`
...
|---|--------|--------|--------|----------|-----------|---------|
| 1 | 试卷页 -> 教材页 | [导航页: exam (/zh-hans/exam)](pages/zh-hans-exam-zh-hans-exam.md) | 教材页（/zh-hans/textbook） | PASS | 未纳入本轮探针 | 部分闭环 |
| 2 | 收藏夹 -> reading | [导航页: favorites (/zh-hans/favorites)](pages/zh-hans-favorites-zh-hans-favorites.md) | reading（/zh-hans/reading） | PASS | 未纳入本轮探针 | 部分闭环 |
| 3 | 首页 -> 教材页 | [主页（/zh-hans/home）](pages/zh-hans-home-zh-hans-home.md) | 教材页（/zh-hans/textbook） | PASS | 未纳入本轮探针 | 部分闭环 |
| 4 | 作业页 -> 教材页 | [导航页: homework (/zh-hans/homework)](pages/zh-hans-homework-zh-hans-homework.md) | 教材页（/zh-hans/textbook） | PASS | 未纳入本轮探针 | 部分闭环 |
| 5 | 班级页 -> 教材页 | [导航页: joined-classes (/zh-hans/joined-classes)](pages/zh-hans-joined-classes-zh-hans-joined-classes.md) | 教材页（/zh-hans/textbook） | PASS | 未纳入本轮探针 | 部分闭环 |
| 6 | 书单页 -> 教材页 | [导航页: playlist (/zh-hans/playlist)](pages/zh-hans-playlist-zh-hans-playlist.md) | 教材页（/zh-hans/textbook） | PASS | 未纳入本轮探针 | 部分闭环 |

## 1. 试卷页 -> 教材页

- 当前 L2 结论：部分闭环
- 闭环摘要：已发现 试卷页 -> 教材页 的跨页线索，但当前仍停留在部分闭环。
...
- 剩余风险 2：同一工作流还发现 6 个候选后续入口未单独复验：/zh-hans/homework、/zh-hans/joined-classes、/zh-hans/reading、/zh-hans/playlist

## 2. 收藏夹 -> reading

- 当前 L2 结论：部分闭环
- 闭环摘要：已发现 收藏夹 -> reading 的跨页线索，但当前仍停留在部分闭环。
...
- 业务成功判定 3：目标页已纳入本轮探针并形成页面级结论。
- 剩余风险 1：目标页未纳入本轮页面级探针，无法确认转场后的页面级结论。
- 剩余风险 2：同一工作流还发现 6 个候选后续入口未单独复验：/zh-hans/textbook、/zh-hans/homework、/zh-hans/joined-classes、/zh-hans/playlist
...
- 业务成功判定 3：目标页已纳入本轮探针并形成页面级结论。
- 剩余风险 1：目标页未纳入本轮页面级探针，无法确认转场后的页面级结论。
- 剩余风险 2：同一工作流还发现 7 个候选后续入口未单独复验：/zh-hans/homework、/zh-hans/joined-classes、/zh-hans/reading、/zh-hans/playlist

## 4. 作业页 -> 教材页

- 当前 L2 结论：部分闭环
- 闭环摘要：已发现 作业页 -> 教材页 的跨页线索，但当前仍停留在部分闭环。
...
- 业务成功判定 3：目标页已纳入本轮探针并形成页面级结论。
- 剩余风险 1：目标页未纳入本轮页面级探针，无法确认转场后的页面级结论。
- 剩余风险 2：同一工作流还发现 6 个候选后续入口未单独复验：/zh-hans/joined-classes、/zh-hans/reading、/zh-hans/playlist、/zh-hans/favorites

## 5. 班级页 -> 教材页

- 当前 L2 结论：部分闭环
- 闭环摘要：已发现 班级页 -> 教材页 的跨页线索，但当前仍停留在部分闭环。
...
- 业务成功判定 3：目标页已纳入本轮探针并形成页面级结论。
- 剩余风险 1：目标页未纳入本轮页面级探针，无法确认转场后的页面级结论。
- 剩余风险 2：同一工作流还发现 6 个候选后续入口未单独复验：/zh-hans/homework、/zh-hans/reading、/zh-hans/playlist、/zh-hans/favorites

## 6. 书单页 -> 教材页

- 当前 L2 结论：部分闭环
- 闭环摘要：已发现 书单页 -> 教材页 的跨页线索，但当前仍停留在部分闭环。
...
- 业务成功判定 3：目标页已纳入本轮探针并形成页面级结论。
- 剩余风险 1：目标页未纳入本轮页面级探针，无法确认转场后的页面级结论。
- 剩余风险 2：同一工作流还发现 6 个候选后续入口未单独复验：/zh-hans/homework、/zh-hans/joined-classes、/zh-hans/reading、/zh-hans/favorites
