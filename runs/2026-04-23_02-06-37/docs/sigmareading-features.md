...
### 4. 导航页: textbook (/zh-hans/textbook)
...
**详细验证**：[查看该页面详细文档](pages/zh-hans-audio-dictionary-zh-hans-audio-dictionary.md)

**AI 结论草案**：AI 判定 /zh-hans/audio-dictionary 的核心候选功能已完成首轮验证，可继续扩展边界场景。
...
### 6. 导航页: ccswitch (/zh-hans/ccswitch)

**URL**：https://sr.sigmareading.com/zh-hans/ccswitch

**详细验证**：[查看该页面详细文档](pages/zh-hans-ccswitch-zh-hans-ccswitch.md)

**AI 结论草案**：AI 判定 /zh-hans/ccswitch 的核心候选功能已完成首轮验证，可继续扩展边界场景。
...
**详细验证**：[查看该页面详细文档](pages/zh-hans-character-map-create-zh-hans-character-map-create.md)

**AI 结论草案**：AI 判定 /zh-hans/character-map-create 的核心候选功能已完成首轮验证，可继续扩展边界场景。
...
### 8. 导航页: chinese-to-pinyin (/zh-hans/chinese-to-pinyin)
...
**详细验证**：[查看该页面详细文档](pages/zh-hans-copybook-zh-hans-copybook.md)

**AI 结论草案**：AI 判定 /zh-hans/copybook 的核心候选功能已完成首轮验证，可继续扩展边界场景。
...
### 10. 深层页: reading-display (/zh-hans/reading-display/63ec90d4e328e6231bb8b4a2)
...
### 11. 深层页: personal-data (/zh-hans/personal-data/590ea45f-04ee-4f24-b1d9-f3fd38e472aa)
...
**探针摘要**：AI 基于 5 条页面信号、7 条交互信号和 1 个工作流结果形成当前判断。
...
### 12. 深层页: reading-display (/zh-hans/reading-display/672b0940b829737eb3f6b047)
...
### 13. 深层页: playlist-display (/zh-hans/playlist-display/6539da63ca06cb10e16f58ef)
...
### 14. 深层页: playlist-display (/zh-hans/playlist-display/653a1734d448f0607b7aa574)
...
### 15. 深层页: student-invite (/zh-hans/student-invite)
...
### 16. 路由探索: /zh-hans/joined-classes
