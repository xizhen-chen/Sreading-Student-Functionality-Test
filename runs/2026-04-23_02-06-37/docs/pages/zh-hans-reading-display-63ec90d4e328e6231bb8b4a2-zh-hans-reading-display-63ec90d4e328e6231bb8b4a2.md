...
- 可执行操作：button、ion-button、back、multilingual-list、reading-display-all-play、reading-font-size
- 页面加载时触发网络请求 2 个
...
- 页面信号：鲤鱼跳龙门 - SReading；最终 URL: https://sr.sigmareading.com/zh-hans/reading-display/63ec90d4e328e6231bb8b4a2；标题: ©2026 SReading v2.12.12 | 鲤鱼跳龙门；交互元素: 59 个；工作流验证: 文章详情详情工作流=PASS/PASS
...
- 网络信号：GET https://sr.sigmareading.com/services/sr-ms-core/api/readings/63ec90d4e328e6231bb8b4a2；GET https://sr.sigmareading.com/zh-hans/reading-display/63ec90d4e328e6231bb8b4a2
...
- 识别到的选项：button、ion-button、back、multilingual-list、reading-display-all-play、reading-font-size、reading-display-language、reading-display-show-pinyin
...
| 检查详情操作控件 | /zh-hans/reading-display/63ec90d4e328e6231bb8b4a2 | 识别当前详情页是否存在按钮、输入框或其它后续操作控件 | 识别 8 个控件：button；ion-button；back；multilingual-list | PASS | （无） |
