...
- 网络信号：GET https://sr.sigmareading.com/assets/web.BW-l3zzw.js；GET https://sr.sigmareading.com/services/sr-ms-core/api/textbooks/sku-grouped；GET https://sr.sigmareading.com/zh-hans/textbook
