...
| 文章详情详情工作流 | verify | 验证 /zh-hans/reading-display/672b0940b829737eb3f6b047 是否已展示详情内容，并暴露当前页可继续操作的控件。 | 至少识别 2 条可用于描述详情页的文本信号；识别当前详情页是否存在按钮、输入框或其它后续操作控件 | 识别 5 条详情文本信号、8 个控件信号。<br>读取详情内容: 识别 5 条详情文本：©2026 SReading v2.12.12；鲊蓣碴哕变崴蒸强鹮申蜒铷熠汝；40 | PASS |
...
|------|----------|----------|----------|------|----------|
| 读取详情内容 | /zh-hans/reading-display/672b0940b829737eb3f6b047 | 至少识别 2 条可用于描述详情页的文本信号 | 识别 5 条详情文本：©2026 SReading v2.12.12；鲊蓣碴哕变崴蒸强鹮申蜒铷熠汝；40 | PASS | （无） |
