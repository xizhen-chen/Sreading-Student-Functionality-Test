...
- `GET https://sr.sigmareading.com/services/sr-ms-core/api/my-account/chars-map-schemes/in-progress`
...
- `GET https://sr.sigmareading.com/services/sr-ms-core/api/my-account/word-express?page=0&size=20`
