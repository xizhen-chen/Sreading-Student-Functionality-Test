# 页面详细功能文档：导航页: word-express (/zh-hans/word-express)
...
- 目标入口：/zh-hans/word-express
- 最终 URL：https://sr.sigmareading.com/zh-hans/word-express?name=list
- 路径：/zh-hans/word-express
- 页面标题：SReading 识字快车 - AI驱动，结合记忆曲线与先进学习模型，免费个性化复习计划，有趣高效学习，专业字帖字卡生成与下载。
- 截图：`screenshots/exploration/03-nav-zh-hans-word-express.png`

## 功能概览

- 页面上下文：SReading 识字快车 - AI驱动，结合记忆曲线与先进学习模型，免费个性化复习计划，有趣高效学习，专业字帖字卡生成与下载。
...
- 可执行操作：button、menu、multilingual-list、按教材复习、自定义复习、1x
- 页面加载时触发网络请求 3 个
...
| 验证项 | 结果 | 说明 |
|--------|------|------|
| 页面可达 | PASS | 最终到达 /zh-hans/word-express |
| 截图已生成 | PASS | screenshots/exploration/03-nav-zh-hans-word-express.png |
| 交互元素已采集 | PASS | 共采集 60 个交互元素 |
| 网络请求已记录 | PASS | 本页新增 3 个请求 |
| 页面功能入口可见 | PASS | 链接 19 / 按钮 26 / 字段 0 |
